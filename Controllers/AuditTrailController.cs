...
namespace lrsms.Controllers
{
    ...
    public class AuditTrailController : BaseController
    {
        ...
        public AuditTrailController(DataContext context, IHttpContextAccessor contextAccessor, IMapper mapper, CustomSignInManager<AppUser> customSignInManager,UserManager<AppUser> userManager, RoleManager<Role> roleManager, SignInManager<AppUser> signInManager) : base(context, mapper)
        {
